...
```{r, fig.width=15, fig.height=20, include=FALSE}
...
model_selected <- c('S01_Var02.autofit', 'S02_Var02.fit', 'S03_Var07.autofit', 'S04_Var02.fit', 'S05_Var02.autofit', 'S06_Var07.autofit')

arima_type <- c('Log transform automatic', 'Manual with log transformation', 'Automatic', 'Manual with log transformation', 'Automatic', 'Automatic' )


df <- data.frame(group, model_selected, arima_type)

df %>%
  kbl(caption = "Model selection", align = 'c') %>%
